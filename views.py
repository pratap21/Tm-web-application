...
#models
from .models import Patient, Document, TestResult, Label, Alternatelabel
...
class GeneratedReportView(View):
    ...
    def get(self, request, pk):
        ...
        all_label = self.get_all_label(doc1_obj, doc2_obj, doc3_obj, doc4_obj, doc5_obj)
...
class TestResultView(UpdateView):
    model = TestResult
    template_name = 'patient/testresult_update.html'
    def get_success_url(self):
        return reverse(home)